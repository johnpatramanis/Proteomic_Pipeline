...
This guide assumes that you are working on a Linux enviroment, preferably a server. /nIt should work on a Linux personal computer and even on a Macintosh enviroment, but this is not recomended.
